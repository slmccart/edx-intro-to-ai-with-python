...
def individual_probability(people, person, num_genes, has_trait):
    if people[person]["father"] == None and people[person]["mother"] == None:
        return (
            PROBS["gene"][num_genes[person]]
...
def probability_of_gene_from_parent(num_parent_genes):
    match num_parent_genes:
        ...
        case 2:
            return (0.5 * (1 - PROBS["mutation"])) + (0.5 * (1 - PROBS["mutation"]))
